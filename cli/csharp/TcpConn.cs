...
public class TcpConn
{
    ...
    /// 一些通用的基础消息id
    /// </summary>
    public readonly static UInt32 UnKnownMsgId = 0; //未知消息
    public readonly static UInt32 NewConnReqId = 1; //新到连接请求
    public readonly static UInt32 NewConnRspId = 2; //新到连接返回
    public readonly static UInt32 PingId = 10; //ping id
    public readonly static UInt32 PongId = 11; //pong id

    /// <summary>
    /// 一些通用的消息model
    /// </summary>
    [ProtoContract]
    public class UnKnownMsg { 
        [ProtoMember(1)]
        string Description = "";
    }

    [ProtoContract]
    public class NewConnReq { 
        [ProtoMember(1)]
        public Int64 UserId = 0;
        [ProtoMember(2)]
        public string Token = "";
        public NewConnReq() { }
        public NewConnReq(Int64 id, string token) { UserId = id; Token = token; }
    }

    [ProtoContract]
    public class NewConnRsp { 
        [ProtoMember(1)]
    ...
    [ProtoContract]
    public class Ping { 
        public Ping() { SendTimeStamp = TimeHelp.TimeToString(DateTime.Now); }
        [ProtoMember(1)]
